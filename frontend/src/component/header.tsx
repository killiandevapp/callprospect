...
import iconLogin from "../assets/iconLogin.png"; // importe ton image
...
export default function Header() {
  return (
    <header className="header">
      <img src={iconLogin} alt="Git Logo" />
      <div className="container nav">
        <div className="logo">
          <div className="logo-circle">
            <svg className="logo" viewBox="0 0 64 64" aria-label="Logo" role="img">
              <defs>
          ...
          <span>
            Call<span className="text-primary">Prospect</span>
          </span>
        </div>
